...
namespace Metas.Application
{
    public class ExcelFileClass
    {
        //public static class ArquivoExcelCotacoes
        //{
        //    public static string GerarArquivo(ExcelConfigurations configurations,
        //        DateTime dataHoraExtracao,
        //        List<Cotacao> cotacoes)
        //    {
        //        string caminhoArqCotacoes = configurations.DiretorioGeracaoArqCotacoes +
