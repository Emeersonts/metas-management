...
namespace Metas.Infrastructure.Repository
{
    public class RepositoryColaborador : IRepositoryColaborador
    {
        ...
        async Task<DataTable> IRepositoryColaborador.RGetFindMeta(SearchcColaborador dto, int prtipo)
        {
            int cont = 0;
        ...
        async Task<DataTable> IRepositoryColaborador.RGetFindMetaResult(int ANOCICLO, pkxd pkx)
        {
            int cont = 0;
